...
Router({
          ...
          if (e.tapIndex == 0) {
            ...
            wx.getUserProfile({
              ...
              success: (file) => {
                ...
                app.globalData.userInfo = file.userInfo
                console.log(file, app.globalData.userInfo, 'app.globalData.userInfo')
  ...
  setUserWeCahtPhoto: function (url) {
    ...
    wx.downloadFile({
      ...
      // .replace('https://thirdwx.qlogo.cn', 'https://liaolongjun.duapp.com')
  ...
  headimgHD: function (imageUrl) {
    ...
    // console.log('高清的头像', imageUrl.replace('https://thirdwx.qlogo.cn', 'https://wx.qlogo.cn'));        
    return imageUrl
  },
